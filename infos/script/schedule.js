...
var mapLeague = {
  ...
  // BL
  'dat-ll': [39996, window.bhv.schedule.leagueSchedules, 'Landesliga', 50584],
  //'dat-blcup': [33947, window.bhv.schedule.leagueSchedules, 'Bundesliga-Cup', 43518],
  // UL-2
  'dat-ul2': [40004, window.bhv.schedule.leagueSchedules, 'Unterliga - 2', 50611],
  // UL-3
  'dat-ul3': [40003, window.bhv.schedule.leagueSchedules, 'Unterliga - 3', 50649]
};
